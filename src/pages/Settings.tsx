...
import EditableCompanyUploadCard from '@/components/settings/EditableCompanyUploadCard'; // Import the new component
    ...
    <Layout>
      <div className="container mx-auto p-6">
        ...
        <div className="grid grid-cols-1 gap-6">
          <ExcelUploadCard />
          <EditableCompanyUploadCard /> {/* Add the new upload card here */}
