...
import AnalyticsList from './AnalyticsList'; // NEW: Import AnalyticsList
...
const CompanyAdditionalDetailCard: React.FC<CompanyAdditionalDetailCardProps> = ({ company, onDataUpdated, initialTab = 'details' }) => {
  ...
  const [isCreateAnalyticsDialogOpen, setIsCreateAnalyticsDialogOpen] = useState(false); // NEW: State for Analytics dialog
      ...
      <Card className="w-full shadow-md rounded-lg">
        <CardHeader className="pb-4">
          <CompanyAdditionalHeader
            ...
            isCreateAnalyticsDialogOpen={isCreateAnalyticsDialogOpen} // NEW
            setIsCreateAnalyticsDialogOpen={setIsCreateAnalyticsDialogOpen} // NEW
          />
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <Tabs defaultValue="details" value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid w-full grid-cols-2 sm:grid-cols-8 h-10 rounded-lg bg-muted/70 p-1"> {/* Adjusted grid-cols to 8 */}
              <TabsTrigger
                value="details"
              ...
              <TabsTrigger
                value="analytics" // NEW: Analytics Tab
                className="font-semibold data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm data-[state=active]:font-bold"
              >
                Análises
              </TabsTrigger>
            ...
            <TabsContent value="analytics" className="mt-4"> {/* NEW: Analytics Tab Content */}
              <h3 className="text-lg font-semibold mb-4 flex items-center text-primary">
