...
export interface Analytics { // NEW: Analytics interface
  id?: string; // Made optional as it's generated by DB
  user_id: string;
  company_db_id?: string;
  company_excel_id: string;
  title: string | null; // Made nullable
  description?: string | null;
  analysis_date?: string | null; // Made nullable
  category?: string | null; // Made nullable
  result?: string | null; // Made nullable
  created_at?: string; // Made nullable
  updated_at?: string; // Made nullable
  ...
  revenue?: number | null;
  phone_views_percentage?: number | null;
  whatsapp_interactions_percentage?: number | null;
  total_leads?: number | null;
  campaign_id?: string | null; // Explicitly added
  campaign_name?: string | null; // Explicitly added
}